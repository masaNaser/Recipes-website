      ...
      <div className="container mx-auto px-6">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:block">
            <ul className="flex gap-8 items-center font-medium">
              ...
              <li>
                <Link to="/policy" className="hover:text-red-500 transition">Policy</Link>
              </li>
            </ul>
          </nav>
        ...
        <div className={`${isOpen ? "block" : "hidden"} md:hidden pb-4 transition-all duration-300`}>
          <nav className="flex flex-col gap-4 font-semibold text-center bg-gray-50 p-6 rounded-xl">
            ...
            <Link to="/about" className="hover:text-red-500 transition py-2">About</Link>
            <Link to="/policy" className="hover:text-red-500 transition py-2">Policy</Link>
          </nav>
        </div>
      </div>
    </header>
